<template>
            ...
            <div class="row d-flex align-items-center" style="margin-top:50px;">
               <div class="col-lg-8 co-12">
                  <div class="home-slider">
                     <div class="hero-text aos-init aos-animate" data-aos="fade-in-up">
                        <div
               ...
               <div class="col-lg-4 col-12 parallax-container aos-init aos-animate" data-aos="zoom-in-right">
                  <div class="info-list">
                     <div class="image-container">
                        <img src="../assets/images/heroimage2.jpg" alt="Background Image" class="bg-image" />
                        <img src="../assets/images/heroimage1.jpg" data-aos="fade-up"  alt="Foreground Image" class="fg-image float-image" />
                     </div>
   ...
   <section class="skill" id="about"> 
      <div class="heading text-center my-element tmp-scroll-trigger tmp-fade-in animation-order-1">
         <h3>ABOUT</h3>
         <h4>
...
.prj-item > .zoomin > img {
   ...
   /* .parallax-container {
    ...
    .parallax-container:hover .float-image {
